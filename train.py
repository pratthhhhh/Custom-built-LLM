...
from tokenizer import get_tokenizer, format_instruction
...
def collate_fn(batch):
    ...
    pad_x = torch.full((len(xs), max_len), 0, dtype=torch.long)
    pad_y = torch.full((len(ys), max_len), -100, dtype=torch.long)
